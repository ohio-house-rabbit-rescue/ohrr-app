...
If you have already designated OHRR as a beneficiary, or wish to discuss your donation amount, please contact Pat Barron at pbarronosu@aol.com. We look forward to thanking you and recognizing you as a Rescue Rabbit Guardian.`

/** The Legacy Fund contact, as the live site gives it. */
export const LEGACY_CONTACT = { name: 'Pat Barron', email: 'pbarronosu@aol.com' }
