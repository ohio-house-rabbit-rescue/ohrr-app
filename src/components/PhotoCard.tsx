...
export function PhotoCard({
  ...
  return (
    <Link
      to={to}
      className="group relative block aspect-[5/4] overflow-hidden rounded-2xl bg-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:translate-y-0"
    >
      <img
        src={photo}
        alt=""
      ...
      />
      <span className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/75 via-black/35 to-transparent px-3 pb-2.5 pt-8">
