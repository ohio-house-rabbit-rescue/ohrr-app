...
| **Database changes to paste** | Drive "OHRR App Design" → `APPLY-*.sql` (each mirrors `supabase/migrations/*`; paste into Supabase → SQL Editor, in order: `APPLY-ALL-2026-09-17`, `APPLY-2-SCAN-ITEMS`, `APPLY-3-INBOX-BOOKINGS-PAGES`, `APPLY-4-POSTS-REACH`, `APPLY-5-HOURS-IMPACT`) | ✅ cloud | the schema the app expects |
